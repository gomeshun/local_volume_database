...
export async function generateMetadata({
  ...
  return {
    title: object ? `${object.name} member stars | LVDB Explorer` : "Object member stars | LVDB Explorer",
  };
}
...
export default async function ObjectPage({
  ...
  const rows = kinematicsByObjectKey[key] ?? [];
  return <ObjectKinematicsClient object={object} rows={rows} columns={kinematicsColumns} />;
}